        ...
        {loading ? (
          ...
          <div className="text-center py-16 px-4 rounded-2xl bg-steam-card/30 border border-steam-accent/40 space-y-4">
            ...
            <p className="text-sm text-gray-400 max-w-md mx-auto">
              Veritabanınız şu an boş veya aradığınız filtrelere uygun oyun yok. Steam&apos;deki canlı indirimleri hemen çekmek için aşağıdaki butona basın.
            </p>
            <button
              onClick={handleSyncNow}
              disabled={syncing}
